    ...
    return (
        <Slide direction="right" in={ShowBar} mountOnEnter unmountOnExit>
                ...
                <div className="sidenav" id='sidenav' style={{'text-align':'center'}}>
                    ...
                    <div style={{'text-align':'center','margin-top':'20%','margin-bottom':'10%','color':'white'}} ><h3 className='medtagtitle'>MedTAG</h3>
                    </div>
                ...
                <hr />
                    ...
                    {/*    <Link onClick={()=>SetShowBar(false)} to="/reports_stats">Reports' stats</Link>*/}
                    ...
                    <Link onClick={()=>SetShowBar(false)} to="/exatag/my_stats">My stats</Link>
                    ...
                    <Link onClick={()=>SetShowBar(false)} to="/exatag/uploadFile">Upload/Transfer annotations</Link>
                    <hr/>
                    {(Admin === Username || (Admin === '' && Username === 'Test') || Username === 'Test') &&<div> <Link onClick={()=>SetShowBar(false)} to="/infoAboutConfiguration">Configure</Link>

                        <Link onClick={()=>SetShowBar(false)} to="/exatag/reports_stats">Reports' stats</Link>
                        <Link onClick={()=>SetShowBar(false)} to="/exatag/team_members_stats">Members' stats</Link>
                    </div>}
