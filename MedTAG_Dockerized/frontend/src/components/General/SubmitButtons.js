...
function SubmitButtons(props){
    ...
    const deleteEntries = (event,token)=>{
        ...
        if(token === 'mentions'){
            ...
            axios.post('mention_insertion/delete', {language:Language,report_id: Reports[Index].id_report})
                .then (function (response) {
                    // console.log(response);
                    //SetSavedGT(false)
                    SetSavedGT(prevState => !prevState)
            ...
            axios.post('annotationlabel/delete', {language:Language,report_id: Reports[Index].id_report})
                .then(function (response) {
                    // console.log(response);
                    //SetSavedGT(false)
                    SetRadioChecked(false)
            ...
            axios.post('insert_link/delete', {language:Language,report_id: Reports[Index].id_report})
                .then (function (response) {
                    // console.log(response);
                    //SetSavedGT(false)
                    SetSavedGT(prevState => !prevState)
            ...
            axios.post('contains/delete', {language:Language,report_id: Reports[Index].id_report})
                .then (function (response) {
                    // console.log(response);
                    // SetSavedGT(false)
                    SetSavedGT(prevState => !prevState)
