...
function SubmitButtons(props){
    ...
    const deleteEntries = (event,token)=>{
        ...
        if(token === 'mentions'){
            ...
            axios.post('http://0.0.0.0:8000/mention_insertion/delete', {language:Language,report_id: Reports[Index].id_report})
                .then (function (response) {
                    // console.log(response);
                    //SetSavedGT(false)
                    SetSavedGT(prevState => !prevState)
            ...
            axios.post('http://0.0.0.0:8000/annotationlabel/delete', {language:Language,report_id: Reports[Index].id_report})
                .then(function (response) {
                    // console.log(response);
                    //SetSavedGT(false)
                    SetRadioChecked(false)
            ...
            axios.post('http://0.0.0.0:8000/insert_link/delete', {language:Language,report_id: Reports[Index].id_report})
                .then (function (response) {
                    // console.log(response);
                    //SetSavedGT(false)
                    SetSavedGT(prevState => !prevState)
            ...
            axios.post('http://0.0.0.0:8000/contains/delete', {language:Language,report_id: Reports[Index].id_report})
                .then (function (response) {
                    // console.log(response);
                    // SetSavedGT(false)
                    SetSavedGT(prevState => !prevState)
