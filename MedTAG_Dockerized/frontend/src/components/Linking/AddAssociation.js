...
function AddAssociation(props){
    ...
    const { tokens, conceptModal,showSnack,showmember, showautoannotation,showSnackMessage,color, disabled,allMentions,disButton, semanticArea,associations,concepts } = useContext(AppContext);
