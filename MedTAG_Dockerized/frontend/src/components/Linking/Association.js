            ...
            <div className="mentAndButt">
                <Row >
                    <Col md={8} className='right'>
                         ...
                         <span>
                    <button style={{'text-align':'left'}} id={props.id} className="butt_linked" name={props.index} type="button" onMouseOver={(e)=>handleHighlight_Over(e,'over')} onMouseOut={(e)=>handleHighlight_Over(e,'out')} onClick={()=>handleHighlight(WordsMention,'')}>
                    ...
                    <Col md={4} className='right'>
                        {ShowAutoAnn === false && ShowMemberGt === false && <span>
                            ...
                            {/*<button id="Click" style={{'float':'right'}} onClick={(e)=> ShowDialog(e)} type="button" value="Link" className="btn btn-primary btn-clicker">Link</button>*/}
