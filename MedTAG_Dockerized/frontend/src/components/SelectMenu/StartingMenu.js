...
function StartingMenu(props){
    ...
    const [PubOptions_usecases, SetPuboptions_usecases] = useState([])
    ...
    const [MedTAGPresence,SetMedTAGPresence] = useState(false) // ADDED 210/10/21
    ...
    useEffect(()=>{
        ...
        axios.get('http://0.0.0.0:8000/check_medtag_reports').then(function(response){
            if(response.data['count'] > 0){
                ...
                options_reps.push({value: 'reports', label: 'MedTAG reports'})
        ...
        SetOptions_reptype(options_reps) //Added 21/10/21
    ...
    return(
        ...
        <div style={{'text-align':'center','margin-top':'20px'}}>
            ...
            <Row>
                <Col md={12}>
                    {Options_reptype !== [] && <div style={{'text-align':'center','margin-top':'40px'}}>
                        ...
                        <div style={{'margin-left':'20%','margin-right':'20%'}}><Select
                            ...
                            options={Options_reptype} // ADDED 21/10/21
            ...
            <Row>
                <Col md={12}>
                    {Rep === 'reports'  && <div style={{'text-align':'center'}}>
                        <>
                    ...
                    {Rep === 'pubmed'  && <div style={{'text-align':'center'}}>
                        <>
                            <div><FontAwesomeIcon icon={faMicroscope}  /> Use Case</div>
                            <div style={{'margin-left':'20%','margin-right':'20%'}}><Select
                                className='selection'
                                onChange={(option)=>handleChangeUseCase(option)}
                                options={PubOptions_usecases}
                            /><hr/></div></>
                    </div>}
                </Col></Row>
            {Use !== '' && BatchList.length > 1 && <Row>
                <Col md={12}>
                    <div style={{'text-align':'center'}}>
                        <>
                            <div><FontAwesomeIcon icon={faListOl}  /> Batch number</div>
                            <div style={{'margin-left':'20%','margin-right':'20%'}}><Select
                                className='selection'
            ...
            {(Rep !== '' && (Rep === 'reports' || PubMedPresence === false)) && <Row>
                <Col md={12}>
                    <div style={{'text-align':'center'}}>
