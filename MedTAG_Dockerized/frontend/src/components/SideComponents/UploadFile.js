        ...
        <div className="App">
            <div>
                <Container fluid>
                    ...
                    <div>
                        The annotations created by the team members who share MedTAG can be <b>copied</b> from a user to another. This allows you to have the ground-truths of a team mate of yours ready to be re-edited by you and not create ex novo a ground-truth.
                        ...
                        <hr/>
                        <div>
                            Uploading new annotations might lead to collisions if the team mate you are uploading the annotations of and you have annotated the same reports.
                            <div style={{marginTop:'1%'}}>
                                ...
                                /> If your team mate and you annotated the same reports, the ground truths of your team mate will <b>overwrite</b> yours in case of collision</label><br/>
                                <label><input
                                    type="radio"
                                    name='collision'
                                    defaultChecked={true}
                                ...
                                /> If your team mate and you annotated the same reports, the ground truths of your team mate will be <b>ignored</b> in case of collision.</label>
                        ...
                        <div>
                            <Collapse style={{marginTop:'0px'}} in={showTransfer}>
                                <div>
                                    <b>If you share MedTAG with other team members</b> you can select the team member you desire and copy his annotations for the annotation type you are interested in.
                                    <Row>
                                        <Col md={2}></Col>
                                        <Col md={8}>
