...
import {
    ...
    faTimesCircle, faCheckSquare, faMousePointer, faProjectDiagram, faTimes, faDownload
            ...
            <div >
                ...
                <Container fluid>
                    ...
                    <div className='Tutorial'>
                        ...
                        <h6>In this section we explain in details how MedTAG works, its main components and how you can create your own ground-truths.</h6>
                        {/*<div>In the video below Gianmaria Silvello introduces you ExaTAG and its features. </div>*/}
                        {/*<video style={{'margin-top':'20px'}} width="60%"  controls src="http://examode.dei.unipd.it/exatag/static/videos/MedTAG_tutorial_brief.mp4" />*/}
                        <hr/>
                        </div>
                        <div>
                        ...
                        <div>If it is the first time you log in, and you have never annotated a report, you will be asked to choose an annotation type between <i>Labels, Linking, Mentions, Concepts.</i></div>
                        <div>If you have already annotated some reports for the configuration you selected, you will be provided with the last ground-truth you created.</div>
                        <hr/>
                            <div>The first time you try MedTAG, you run in TEST mode. The database is populated with a sample of data which allow you to try the application and to understand how the annotations work. In order to change the configuration, and populate the database with your data, you can open the side menu clicking on <FontAwesomeIcon icon={faBars}/> and select <i>Configuration</i>. Then, a list of instructions is displayed: follow them and at the end you can start annotating your own reports.
                                <div><span style = {{'font-weight':'bold'}}>NOTE: </span><span>You can change configuration only if you are the admin of MedTAG. If you are not, the <i>Configure</i> option will not be present in the side menu.</span></div>
                                <div>If you are interested in how to configure MedTAG, please, <a href='http://0.0.0.0:8000/infoAboutConfiguration'>click here</a>.</div>
                            </div>
                        ...
                        <div>In the home screen you can find three main components explained below.</div>
                            ...
                            <div>This is located at the top of the page and it includes:
                                <ul className="fa-ul">
                                    <li><span className="fa-li"><FontAwesomeIcon icon={faBars}/></span>
                                        The side menu where you can find the <i>Configure, Credits, Tutorial, Home</i> sections.
                                    </li>
                                    <li>
                                        The actual configuration which includes the actual <FontAwesomeIcon icon={faMicroscope}/>&nbsp;<i>Use case</i>, the&nbsp;
                                        <FontAwesomeIcon icon={faLanguage}/>&nbsp;<i>Language</i> and the <FontAwesomeIcon icon={faHospital}/>&nbsp;<i>Institute</i>. The actual
                                        configuration is modifiable clicking on <span className='configuration_btn '><Button id='conf' style={{'padding':'0','font-size':'10px','height':'25px','width':'76px'}} variant='success'> <FontAwesomeIcon icon={faCogs} /> Change</Button></span>.&nbsp;
                                    </li>
                                    ...
                                    <li><span className="fa-li"><FontAwesomeIcon icon={faDownload}/></span>
                                        ...
                                        you can download your ground-truths according to the configuration you prefer. You can download your ground-truths in: JSON, CSV or BioC (XML or JSON). When you select BioC option, you can download also the key file associated to the annotation type you selected. The key file describes the semantics of tags.
                                    </li>
                                    <li><span className="fa-li"><FontAwesomeIcon icon={faUser}/><FontAwesomeIcon icon={faRobot}/><FontAwesomeIcon icon={faUserEdit}/></span>
                                        These three buttons positioned between the <i>CLEAR</i> and <i>SAVE</i> buttons allow you to be provided with two ground truths: the one of the algorithm, if you have automatically annotated the report, and the annotation of a team member you can choose (by default, every time you log in you are provided with the ground truth of the admin, you can change the team member clicking on: <FontAwesomeIcon icon={faExchangeAlt}/>.</li>
                            ...
                            <hr/>
                            <h5>The Report</h5>
                            <div>On your left you can find the report to annotate. Each report includes the fields you decided to display. If you are running in the test mode instead, the fields are those of the reports we provided.<br/>The three fields below are always displayed.
                            <ul>
                                <li><span className='tutorial_li'>Reports' order</span>: you can choose between the <i>lexicographical order</i> of your reports' ids and the <i>annotated reports' order</i>, that is a list which contains in the first positions the reports you have not annotated yet and, in the last positions, all the reports you have already annotated.</li>
                                ...
                                <div>If you want to jump to a precise report, go to the bar next to the REPORT title and select the one you prefer. The reports you have not annotated yet are in <span style={{'font-weight':'bold'}}>bold face</span>.</div>
                            </div>
                            <hr/>
                                    ...
                                    <li>
                                        ...
                                        {ShowLabelsTutorial && <div>
                                            <ul className="fa-ul tutorial-ul">
                                                ...
                                                <li><span className="fa-li"><FontAwesomeIcon icon={faSave}/></span>Your changes will be saved clicking on <span style={{'color':'green'}}>SAVE</span> button, changing annotation typess or
                                    ...
                                    <li>
                                        ...
                                        {ShowLinkingTutorial && <div>
                                            <ul className="fa-ul tutorial-ul">
                                                ...
                                                <li><span className="fa-li"><FontAwesomeIcon icon={faPlusCircle}/></span> Choose a semantic area and then a concept, you can select a concept also without pre-selecting a semantic area. Add the linked concept clicking on “Add”. The concept will be automatically displayed under its mention. Click on the concept to have some information about it.
                                                </li>
                                    ...
                                    <li>
                                        ...
                                        {ShowMentionsTutorial && <div>
                                            <ul className="fa-ul tutorial-ul">
                                                ...
                                                <li><span className="fa-li"><FontAwesomeIcon icon={faPalette}/></span>Once you added the mention this will have a color. In the textual report the words which characterize a mention will not be selectable any more. The punctuation has been removed from all the mentions in the mentions list on your right.
                                                </li>
                            ...
                            <div>
                                ...
                                <div>You can upload one or more sets of PubMed articles, the only information about articles we ask you to provide is the PubMed ID associated to the article and the use case you decide to associate to it. Associating a use case to a PubMed article allows you to rely on the set of labels and concepts of that use case during the annotation process.
                                If you are interested in how to create the files with PubMed ids click <a href='http://0.0.0.0:8000/infoAboutConfiguration'>here</a></div>
                            </div><hr/>
                            <div>
                            ...
                            <div>
                                <ul>
                                    ...
                                    {/*</li>*/}
                                    <li>
                                        If you do not logout before leaving MedTAG, the next time you open MedTAG the last configuration will be restored. If you do not want to be provided with your previous configuration, please logout before leaving.
                                    </li>
                                    <li>
                                        Use Chrome to have the best experience.
                                    </li>
                                    <li>
                                        As more reports you have to automatically annotate as more time it takes. Make sure your machine is powerful enough to perform this task.
                                    </li>
                                </ul>
                            </div>
