            ...
            axios({
                ...
                .then(function (response) {
                    ...
                    if(response.data['message'] !== undefined){
                        SetLoadingResponse(false)
                        SetMessage('MedTAG has been correctly updated.')
        ...
        <div className="App">
            ...
            {LoadingResponse === false && LoadingAuto === false && Message === '' &&  ErrorMessage === '' && ErrorAuto === 0 && <div>
                ...
                <Container fluid>
                    ...
                    <div>
                        <h2 style={{'margin-top':'30px','margin-bottom':'30px','text-align':'center'}}>Update your MedTAG configuration</h2>
                        <div>
                                                ...
                                                {FieldsAlreadyExtracted && FieldsUseCasesToExtract && AutoOpt !== '' && <div>
                                                    ...
                                                    <div style={{marginTop:'1%'}}>
                                                            ...
                                                            <div style={{'text-align':'center','margin-top':'2%'}}>
                                                                {(ReportsMissingAuto[AutoOpt][Batch]['annotated']===ReportsMissingAuto[AutoOpt][Batch]['tot'] && CommitPossible && FieldsAlreadyExtracted[AutoOpt].length > 0) ? <div style={{'color':'green','font-weight':'bold'}}>All the reports for this configuration have been automatically annotated. </div> : <Button id='commit_extracted' disabled={FieldsAlreadyExtracted[AutoOpt].length === 0 && SelectedFields[AutoOpt].length === 0} size='lg' variant='success' onClick={()=>checkemptyuses(AutoOpt)}>Get the automatic annotations</Button>}
                                                            </div>
                            ...
                            <Collapse style={{marginTop:'0px'}} in={showAddSection}>
                                ...
                                <div>
                                    <div>
                                        <h4>Examples</h4>
                                        <ul>
                                            <li><Row><Col md={4}>Label file:</Col><Col md={8}><Button variant='info' size='sm' onClick={(e)=>SetShowLabelsExamples(prev=>!prev)}>Show</Button></Col></Row>
                                            ...
                                            <li><Row><Col md={4}>PubMed ids file:</Col><Col md={8}><Button variant='info' size='sm' onClick={(e)=>SetShowPubmedExamples(prev=>!prev)}>Show</Button></Col></Row>
                                            ...
                                            <li><Row><Col md={4}>Reports file:</Col><Col md={8}> <Button variant='info' size='sm' onClick={(e)=>SetShowReportsExamples(prev=>!prev)}>Show</Button></Col></Row>
                                            ...
                                            <li><Row><Col md={4}>Concepts file:</Col><Col md={8}> <Button variant='info' size='sm' onClick={(e)=>SetShowConceptsExamples(prev=>!prev)}>Show</Button></Col></Row>
                                    ...
                                    <Form>
                                        ...
                                        {Selected === 'reports' && <div>
                                            <Form.Group>
                                                <Form.File  multiple id="exampleFormControlFile1" onClick={(e) => {SetKeysUpdate([]);SetShowDeleteReports(false);(e.target.value = null);SetAdded(false);SetWarning('');SetChecked(0);SetUsesUpdate([])}} onChange={(e)=>{SetAdded(true);showKeys_setUseCase();showDelete(e,'reports')}} label="Select the reports file" />
                                            </Form.Group>
